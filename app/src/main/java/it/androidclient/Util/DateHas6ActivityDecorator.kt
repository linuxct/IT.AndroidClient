...
class DateHas6ActivityDecorator(context: Activity?, private val achievementCounterHelper: AchievementCounterHelper) : DayViewDecorator {
    ...
    init {
        ...
        drawable = ContextCompat.getDrawable(context!!, R.drawable.day_decorator_6)
    }
}